...
const HowItWorksSection = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Our AI gets to work, sniffing out every mention and analyzing the true sentiment behind the words.",
      color: "#10B981",
      number: "02",
    },
    {
      ...
      description: "View everything on a single, beautiful dashboard and make smarter decisions with data you can trust.",
      color: "#8B5CF6",
      number: "03",
    },
  ];
