...
//   }
// }
import { PrismaClient, prisma, Prisma } from "@repo/db";
import { createRepository } from "../db-helpers/create-repository";

export const taskRepository: ReturnType<
  typeof createRepository<
    PrismaClient["task"],
    Prisma.TaskDefaultArgs,
    Prisma.TaskGetPayload<Prisma.TaskDefaultArgs>
  >
> = createRepository(prisma.task);
